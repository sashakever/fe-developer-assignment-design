...
const IconWrapper: FC<Props> = ({className = '', isActive, icon}) => {
  return (
    <div
      className={clsx(
        'relative flex h-[114px] w-[100px] items-center justify-center',
        className,
      )}>
      <svg
        ...
        <g clipPath='url(#clip0_30_50)'>
          <path
            ...
            stroke='url(#paint0_linear_30_50)'
            strokeDasharray='8 8'
          />
          <path
            className={clsx('fill-white transition-all duration-300', {
              'opacity-[0.05]': !isActive,
